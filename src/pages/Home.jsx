...
const Home = () => {
  ...
  return (
    <div id="home" className="relative  w-full min-h-screen bg-hero bg-cover bg-center overflow-hidden">
      <div className="absolute inset-0">
        {theme === "dark"?<img  src="https://wallpapers.com/images/hd/solid-black-4k-black-platforms-cmhse13n38qpqhnk.jpg " className="w-full h-full object-cover bg-black/60" />
           :<img src="https://e0.pxfuel.com/wallpapers/674/1010/desktop-wallpaper-plain-white.jpg" className="w-full h-full object-cover"/> }
        <div className="absolute inset-0 " />
      </div>
      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-center min-h-screen max-w-7xl mx-auto px-4 md:px-8 gap-8 md:gap-16">
        <div className="text-center md:text-left space-y-5 max-w-lg">
          ...
          <p className="text-base sm:text-lg md:text-xl ">
            Welcome to <span className="font-semibold text-blue-400">ShoeStore</span> – find the best shoes for your style and comfort.
          </p>
        ...
        <div className="relative max-w-[280px] sm:max-w-xs md:max-w-md lg:max-w-lg">
          {/* {theme === "dark" ?<img
            src="https://i.pinimg.com/originals/4b/62/97/4b62975d1dca180da8a533a34f5bb231.gif"
            alt="Nike Shoe"
            className="w-full animate-float transition-transform duration-500 hover:scale-105"
          />:<img
            src="https://www.icegif.com/wp-content/uploads/2023/12/icegif-23.gif"
            alt="Nike Shoe"
            className="w-[70%] animate-float transition-transform duration-500 hover:scale-105 "
          />} */}
          <img src="https://i.gifer.com/O4ch.gif" alt="" className="w-[100%] animate-float transition-transform duration-500 hover:scale-105 rounded-4xl "/>
